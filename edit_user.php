  					...
  					<form method="POST" action="input_edit_user.php">
						...
						<div class="form-group">
  						...
  						<div class="form-group">
    						...
    						<input type="text" class="form-control" id="mail" placeholder="example@gmail.com" name="email" value="<?php echo $row["email"] ?>">
  						</div>

  						<div class="form-group">
    						<label for="telp">No. Telepon</label>
    						<input type="text" class="form-control" id="telp" placeholder="ex: 082212341234" name="telp" value="<?php echo $row["telp"] ?>">
  						</div>

  						<div class="form-group">
    						<label for="alamat">Alamat</label>
    						<input type="text" class="form-control" id="alamat" placeholder="Alamat" name="alamat" value="<?php echo $row["alamat"] ?>">
  						</div>

              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="user">Username Akun</label>
                    <input type="text" class="form-control" id="user" placeholder="Username" readonly name="username_user" value="<?php echo $row["username_user"] ?>">
                </div>

                <div class="form-group col-md-6">
                  <label for="pass">Password Akun</label>
                    <input type="text" class="form-control" id="user" placeholder="Password" name="pass_user" value="<?php echo $row["pass_user"] ?>">
                </div>
              </div>
              
  						<center><br><input class="btn btn-primary" type="submit" name="simpan" value="Simpan Perubahan"><br></center>
  					</form>		
  				</div>
			</div>
			<?php } ?>
