		...
		<div class="main">
          ...
          <div class="card" style="">
          	<div class="card-header text-center">
                <p class="text-center"><h3>Data Kendaraan</h3></p>
            </div>

            <div class="card-body">
            	<form method="POST" action="input_kendaraan.php">
                    ...
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">ID Kendaraan</span>
                      </div>
                      <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" readonly name="id_k" value="<?php echo rand(100000000,999999999)?>">
                    </div>

                    <div class="form-row">
                    	<div class="form-group col-md-6">
                        <label for="kategori">Kategori</label>
                          <select class="form-control" id="kategori" name="jenis_k">
                            <option>Mobil</option>
                            <option>Motor</option>
                          </select>
                      	</div>
                    ...
                    <div class="form-group">
    					         ...
    					         <textarea class="form-control" id="keterangan" rows="5" name="ket_k"></textarea>
  					         </div>
