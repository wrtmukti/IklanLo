		...
		<div class="main">
          ...
          <div class="card" style="">
          	<div class="card-header text-center">
                <p class="text-center"><h3>Data Perlengkapan</h3></p>
            </div>

            <div class="card-body">
            	<form method="POST" action="input_perlengkapan.php">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" readonly name="id_p" value="<?php echo rand(100000000,999999999)?>">
                    </div>

                    <div class="form-row">
                    	<div class="form-group col-md-6">
                        <label for="kategori">Kategori</label>
                          <select class="form-control" id="kategori" name="jenis_p">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select class="form-control" id="kondisi" name="kondisi_p">
                            <option>Baru</option>
                            <option>Bekas</option>
                          </select>
                        </div>
                    ...
                    <div class="form-group">
    					         ...
    					         <textarea class="form-control" id="keterangan" rows="5" name="ket_p"></textarea>
  					         </div>
